    ...
    public partial class initialize : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TradeClassificationID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Atmospheres = table.Column<string>(nullable: false),
                    Classification = table.Column<string>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    Gov = table.Column<string>(nullable: false),
                    Hydro = table.Column<string>(nullable: false),
                    IsManuallyAssigned = table.Column<bool>(nullable: false),
                    Law = table.Column<string>(nullable: false),
                    Name = table.Column<string>(nullable: false),
                    Pop = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorldTCID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TradeClassificationID = table.Column<int>(nullable: false),
                    WorldID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorldTCs", x => x.WorldTCID);
                });
